    ...
    <div className="space-y-16">
      <section className="grid gap-10 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/30 backdrop-blur md:grid-cols-2 md:p-12">
        ...
        <div className="space-y-4">
          <HeroScene />
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 text-white shadow-lg shadow-black/20">
            <h2 className="text-xl font-bold">Tonight&apos;s pitch is yours.</h2>
